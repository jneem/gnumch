...
pkgdatadir = $(datadir)/gnumch
pkgincludedir = $(includedir)/gnumch
pkglibdir = $(libdir)/gnumch
pkglibexecdir = $(libexecdir)/gnumch
...
CXXFLAGS = -Wall  -I/usr/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT -O2
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
LIBINTL = 
LIBOBJS = 
LIBS =  -L/usr/lib -lSDL -lpthread -lSDL_image -lSDL_ttf -lSDL_gfx -lSDL_mixer
LTLIBICONV = -liconv
LTLIBINTL = 
LTLIBOBJS = 
MAKEINFO = makeinfo
...
PACKAGE_BUGREPORT = 
PACKAGE_NAME = gnumch
PACKAGE_STRING = gnumch 0.2.0
PACKAGE_TARNAME = gnumch
PACKAGE_URL = 
